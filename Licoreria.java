...
public class Licoreria {
	...
	public Licoreria(String nombre, String gerente) {
		this.nombre = nombre;
	...
	public String masCaro() {
		...
		int indice = ManejadorArreglos.indiceMayorD(precio, numLicores);
	...
	public int compareTo(Licoreria otro) {
