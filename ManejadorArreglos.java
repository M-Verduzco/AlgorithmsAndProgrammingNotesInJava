...
//**************INTERCAMBIA EL VALOR  'A' Y EL 'B' STRING*************
...
//************CORRIMIENTOS INSERTAR DATO STRING**************//
	public static void corrimientosInsertarDatosS (String []a, int pos, int n, String dato) {
...
//***********EJERCICIO 07/10/2020**************//
	public static void eliminaRepetidos (Integer  [] a, ArrayList<Integer> l){
		int indice;
		for(int i=0; i<a.length; i++) {
			indice = l.indexOf(a[i]);
			if(indice!=-1)
				l.remove(indice);
		}
	}
